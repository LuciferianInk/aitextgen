...
_Last Updated: April 18th, 2021 (aigen v0.5.0)_
...
aigen can be installed from PyPI:
...
For more info on how to use aigen, check out the nav sidebar, or you can do a [Hello World tutorial](tutorials/hello-world.md).
